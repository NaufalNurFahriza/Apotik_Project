...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Laporan Aktivitas Member</h1>
    <div>
...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="<?= base_url('laporan/member'); ?>" method="get" id="formFilter">
            <div class="row">
                <div class="col-md-4">
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Aktivitas Member</h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered dataTable" width="100%" cellspacing="0" id="dataTable">
                ...
                <tbody>
                    <?php $i = 1; ?>
                    <?php foreach ($aktivitas_member as $member) : ?>
                        <tr>
                            <td><?= $i++; ?></td>
                            <td><?= $member['nama_member']; ?></td>
                            <td><?= $member['no_hp']; ?></td>
                            <td><?= $member['jumlah_transaksi']; ?></td>
                            <td>Rp <?= number_format($member['total_belanja'], 0, ',', '.'); ?></td>
                            <td><?= $member['poin']; ?> poin</td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
