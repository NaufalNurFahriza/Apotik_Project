...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Edit TTK</h1>
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <i class="fas fa-user-edit"></i> Form Edit TTK
        </h6>
    </div>
    <div class="card-body">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control <?= ($validation->hasError('nama')) ? 'is-invalid' : ''; ?>" 
                           id="nama" name="nama" value="<?= (old('nama')) ? old('nama') : $user['nama']; ?>" required>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <input type="text" class="form-control <?= ($validation->hasError('username')) ? 'is-invalid' : ''; ?>" 
                           id="username" name="username" value="<?= (old('username')) ? old('username') : $user['username']; ?>" required>
                    <div class="invalid-feedback">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-9">
                    <select class="form-select <?= ($validation->hasError('role')) ? 'is-invalid' : ''; ?>" 
                        ...
                        <option value="ttk" <?= ((old('role')) ? old('role') : $user['role']) == 'ttk' ? 'selected' : ''; ?>>TTK (Tenaga Teknis Kefarmasian)</option>
                        <option value="pemilik" <?= ((old('role')) ? old('role') : $user['role']) == 'pemilik' ? 'selected' : ''; ?>>Pemilik</option>
                    </select>
                    <div class="invalid-feedback">
        ...
        <div class="row no-gutters align-items-center">
            <div class="col mr-2">
                ...
                <div class="text-sm text-gray-600">
                    <strong>Dibuat:</strong> <?= date('d/m/Y H:i', strtotime($user['created_at'] ?? 'now')); ?><br>
                    <strong>Terakhir Update:</strong> <?= date('d/m/Y H:i', strtotime($user['updated_at'] ?? 'now')); ?>
                </div>
            </div>
            <div class="col-auto">
