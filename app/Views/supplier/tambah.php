    ...
    <div class="card-body">
        <form action="<?= base_url('supplier/simpan'); ?>" method="post">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control <?= ($validation->hasError('kota')) ? 'is-invalid' : ''; ?>" id="kota" name="kota" value="<?= old('kota'); ?>" required>
                    <div class="invalid-feedback">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control <?= ($validation->hasError('telepon')) ? 'is-invalid' : ''; ?>" id="telepon" name="telepon" value="<?= old('telepon'); ?>" required>
                    <div class="invalid-feedback">
